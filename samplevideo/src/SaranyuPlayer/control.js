...
function Control() {
    return (
        <div>
            {/* <p style={{color:"red"}}>ohm</p>ohm */}
            {/* <div classNameNameName="video-progress">
                <progress id = "progress-bar" value = "0" min = "0" ></progress>
                <input classNameNameName = "seek-bar" id = "seek-bar" value = "0" min = "0" type = "range" step = "1"  />
                <div classNameNameName = "seek-tooltip" id = "seek-tooltip" >00:00:00</div>
            </div>
             */}
...
<div className="container">
    <div className="video-container" id="video-container">
      ...
      <video  className="video" id="video" preload="metadata" poster="poster.jpg">
        <source src="https://www.learningcontainer.com/wp-content/uploads/2020/05/sample-mp4-file.mp4" type="video/mp4" type="video/mp4"></source>
      </video>
